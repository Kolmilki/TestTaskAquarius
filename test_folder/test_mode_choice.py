...
@pytest.mark.parametrize(
    ...
    [
        ([f'{get_absolute_path()}c.txt',
          ...
          f'{get_absolute_path()}a.txt'], 1, 3.5, pytest.raises(TypeError)),
        ([f'{get_absolute_path()}fileDirectoryFGH/h.txt',
          f'{get_absolute_path()}fileDirectoryFGH/f.txt'], 'n', 1, pytest.raises(TypeError)),
        ([f'{get_absolute_path()}fileDirectoryFGH/g.txt',
          f'{get_absolute_path()}a.txt'], 1, '1', pytest.raises(TypeError)),
        ([f'{get_absolute_path()}fileDirectory/g.txt',
          f'{get_absolute_path()}a.txt'], 1, '1', pytest.raises(FileNotFoundError)),
    ]
)
